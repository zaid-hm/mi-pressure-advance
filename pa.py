...
def generate_pa_tune_gcode(info: PatternInfo, finished_printing=True):
    def gcode_relative_extrude_move(x=None, y=0.0):
    ...
    gcode = f"""
        ...
        G1 X{info.start_x + info.line_length + BOUNDING_BOX_LINE_WIDTH} Y{info.start_y - info.spacing - BOUNDING_BOX_LINE_WIDTH} Z10 F30000 ; move to start position
